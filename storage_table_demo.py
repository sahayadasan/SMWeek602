...
resourcegroup_name = 'sm_'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'sm_'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'westus'
...
cardealership = Entity()
cardealership.PartitionKey = 'cardealership'
cardealership.RowKey = '003'
cardealership.make = 'BMW'
cardealership.model = 'M3'
cardealership.year = '2017'
cardealership.color = 'Blue'
cardealership.price = 80000
table_service.insert_entity('itemstable', cardealership)
...
print('Created entry for a Starbucks - Pumpkin Spice...\n')
...
coffee.RowKey = '005'
coffee.brand = 'Starbucks'
coffee.flavor = 'Americano'
coffee.size = 'Grande'
coffee.price = 3.50
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Starbucks - Americano...\n')
...
coffee.price = 5.25
table_service.insert_entity('itemstable', coffee)
print('Created entry for a Starbucks - Cappuccino...\n')
time.sleep(1)
...
items = table_service.query_entities('itemstable', filter="PartitionKey eq 'coffee'", select='brand, flavor, size, price')
for item in items:
